...
public static class PageCatalog
{
    public static readonly IReadOnlyList<PageDefinition> All = new[]
    {
        ...
        new PageDefinition("production-voucher",     "Production Voucher",       "vouchers", "Vouchers"),
        new PageDefinition("formulations",           "Formulations",             "vouchers", "Vouchers"),
        new PageDefinition("washing-room",           "Washing Room",             "vouchers", "Vouchers"),
